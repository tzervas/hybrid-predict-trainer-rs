...
fn default_full_steps() -> usize { 20 }
fn default_max_predict_steps() -> usize { 80 }
fn default_confidence_threshold() -> f32 { 0.85 }
fn default_divergence_threshold() -> f32 { 3.0 }
fn default_predictor_memory_budget() -> usize { 50 * 1024 * 1024 } // 50MB
fn default_collect_metrics() -> bool { true }
...
impl HybridTrainerConfigBuilder {
    ...
    pub fn build(self) -> HybridTrainerConfig {
        HybridTrainerConfig {
            ...
            max_predict_steps: self.max_predict_steps.unwrap_or_else(default_max_predict_steps),
            confidence_threshold: self.confidence_threshold.unwrap_or_else(default_confidence_threshold),
            divergence_threshold: self.divergence_threshold.unwrap_or_else(default_divergence_threshold),
            predictor_config: self.predictor_config.unwrap_or_default(),
            predictor_memory_budget: self.predictor_memory_budget.unwrap_or_else(default_predictor_memory_budget),
...
fn default_linear_feature_dim() -> usize { 128 }
fn default_l2_regularization() -> f32 { 0.01 }
fn default_mlp_hidden_dims() -> Vec<usize> { vec![256, 128] }
fn default_activation() -> Activation { Activation::Gelu }
fn default_dropout() -> f32 { 0.1 }
fn default_deterministic_dim() -> usize { 256 }
fn default_stochastic_dim() -> usize { 32 }
fn default_num_categoricals() -> usize { 32 }
fn default_ensemble_size() -> usize { 3 }
...
fn default_gradient_norm_multiplier() -> f32 { 100.0 }
fn default_loss_sigma_threshold() -> f32 { 3.0 }
fn default_vanishing_gradient_threshold() -> f32 { 0.01 }
fn default_check_interval() -> usize { 10 }
...
fn default_save_interval() -> usize { 1000 }
fn default_keep_last_n() -> usize { 3 }
fn default_include_predictor() -> bool { true }
